...
install_x-ui() {
    ...
    #echo -e "Please make sure that this port is not occupied by other programs, ${yellow}and ensure 54321 port is released${plain}"
    ...
    echo -e "x-ui restart      - Start x-ui panel"
